...
<div class="navbar">
    <ul>
        <li><a href="home6.php">HOME</a></li>
        <li><a href="member3.php">MEMBERS</a></li>

        <li><a href="guide5.php">GUIDES</a> </li>
        <li><a href="admin.php">REQUESTS</a> </li>


        <li><a id="reg_btn" href="3rd_reg.php"> Register </a></li>
        <?php if (isset($_SESSION['loggedin'])) : ?>
            <li><a id="out_btn" href="out.php"> Log Out </a></li>
        <?php endif; ?>
...
<ul id="image_gallery">
    ...
    <li>
        <div>
            <h2>COX'S BAZAR</h2>
            <a href="cox's_bazar.html"><img src="pic9.jpg" width="300px" height="250px"></a>
